...
go build -ldflags "-X github.com/lasthyphen/utilitychain/plugin/evm.GitCommit=$coreth_commit -X github.com/lasthyphen/utilitychain/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
